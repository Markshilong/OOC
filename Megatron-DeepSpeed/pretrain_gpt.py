...
def model_provider(pre_process=True, post_process=True):
    ...
    with deepspeed.zero.Init(data_parallel_group=mpu.get_sequence_data_parallel_group(), # edited to compatible with deepspeed new version
