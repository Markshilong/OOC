...
def setup_model_and_optimizer(model_provider_func,
    ...
    if args.deepspeed:
        ...
        if args.data_efficiency_curriculum_learning and build_train_valid_test_datasets_provider is not None:
            ...
            # Megatron-DeepSpeed  deepspeed.initialize()
...
def train(forward_step_func, model, optimizer, opt_param_scheduler,
    ...
    while iteration < args.train_iters and (args.train_tokens is None or \
        ...
        import sys
        sys.path.append('/shared_ssd_storage/shilonglei/OOC/ooc_llm')  # Replace with the actual path to your directory
        import g_var
        g_var._init()
        g_var.set_value(iteration)
