...
template_json="ds_config_gpt_Flow_MoE_TEMPLATE.json"
config_json="ds_config_gpt_Flow_MoE_${NAME}.json"
...
run_cmd="CUDA_VISIBLE_DEVICES=0,1,2,3 FLOW=1 deepspeed ${DIR}/../../pretrain_gpt.py ${megatron_options} ${data_options} ${deepspeed_options}"
echo ${run_cmd}
eval ${run_cmd}
set +x
