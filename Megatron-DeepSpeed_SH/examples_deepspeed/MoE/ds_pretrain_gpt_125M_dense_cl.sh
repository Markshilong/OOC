...
# ---- lsl ----
VOCAB_PATH=/shared_ssd_storage/shilonglei/OOC/Megatron-DeepSpeed/examples/data/gpt2-vocab.json
MERGE_PATH=/shared_ssd_storage/shilonglei/OOC/Megatron-DeepSpeed/examples/data/gpt2-merges.txt
DATA_PATH=/shared_ssd_storage/shilonglei/OOC/Megatron-DeepSpeed/examples/data/meg-gpt2-oscar-en-10k_text_document
# ----------
