...
# --- lsl notes ----
# this .py is from https://github.com/bigscience-workshop/Megatron-DeepSpeed/blob/main/tools/preprocess_data.py
...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__),
                                             os.path.pardir)))
from megatron.data.indexed_dataset import __best_fitting_dtype
import time
